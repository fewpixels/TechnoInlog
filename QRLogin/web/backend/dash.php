...
<table class = "sheet">
  ...
  foreach($scanList as $singleScan){
    ...
    echo "<td> <a id='dashName' href='dashUser.php?user=" . $singleScan->userID . "'>" . $singleScan->naam . "</a> </td>"; 
    ...
    echo "<td>" . "<a href='confirmRecordDelete.php?id=".$singleScan->id."'><button type='button'>Verwijderen</a></button>"; 
    echo "</tr>";
  }
  ?>
 </table>
